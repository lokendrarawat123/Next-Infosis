  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-6">
      ...
      <FormModal
        ...
        size="lg"
        isSubmitting={editId ? isUpdating : isSaving}
        submitText={editId ? "Update Service" : "Save Service"}
        loadingText={editId ? "Updating..." : "Saving..."}
        formClassName="space-y-6 pt-2"
        footerClassName="flex justify-end gap-3 border-t pt-6"
      >
        <Input
          label="Service Name"
